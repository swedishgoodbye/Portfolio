            ...
            <div className="contact-page main-item">
                ...
                <div class="inner">
                        ...
                        <div className="contactlist">
                            ...
                            <a href="https://github.com/opticalfalicy" className="contact-git"><img src={require('../../media/GitHub-Mark-Light-64px.png')}/></a>
                            <a href={"mailto: brettsullivan@opticalfalicy.com"} className="contact-email">brettsullivan@opticalfalicy.com</a>
                            <a href="tel:(708)-971-9389" className="contact-item cellcontact" id="webcell">(708)-971-9389</a>
                            <a href="tel:(708)-971-9389" className="contact-item cellcontact" id="mobilecell">Call Me</a>
                        </div>
